                ...
                <div className='grid w-full justify-between sm:flex md:grid-cols-1'>
                    ...
                    <div className='grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6'>
                        ...
                        <div>
                            ...
                            <Footer.LinkGroup col>
                            <Footer.Link href='https://www.github.com/vaibhavbaneshi' target='_blank' rel='noopener noreferrer'>
                                    Github
                                </Footer.Link> 
                            <Footer.Link href='https://www.linkedin.com/in/vaibhav-baneshi-89089521b/' target='_blank' rel='noopener noreferrer'>
                                    Linkedin 
                                </Footer.Link> 
                            </Footer.LinkGroup>
                        </div>
